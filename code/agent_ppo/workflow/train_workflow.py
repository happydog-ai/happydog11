    ...
    def run_episodes(self):
        ...
        while True:
            ...
            while not done:
                ...
                reward_info = self.agent.preprocessor.reward_info
                ...
                frame = SampleData(
                    ...
                    reward=reward_arr,
                    cleaning_reward=np.array([reward_info["cleaning_reward"]], dtype=np.float32),
                    dirt_approach_reward=np.array([reward_info["dirt_approach_reward"]], dtype=np.float32),
                    obstacle_reward=np.array([reward_info["obstacle_reward"]], dtype=np.float32),
                    charger_reward=np.array([reward_info["charger_reward"]], dtype=np.float32),
                    step_penalty=np.array([reward_info["step_penalty"]], dtype=np.float32),
